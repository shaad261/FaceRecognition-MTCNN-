...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        link2 = tk.Label(self.window, text="shaad261@gmail.com", fg="blue", )
        link2.place(x=690, y=580)
        # link2.pack()
        link2.bind("<Button-1>", lambda e: self.callback("https://github.com/shaad261/Facereconition_app.git"))
    ...
    def collectUserImageForRegistration(self):
        ...
        self.trainModel()
        notifctn2 = "We have Trained the model for the images taken."
